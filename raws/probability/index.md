...
Notes on uncertainty, statistics, stochastic processes, and estimation for robotics.

## Notes

- [The central limit theorem](central-limit-theorem-summary.md)
- [Covariance, centering, trace, and degrees of freedom](centering-covariance-trace-n-minus-1.md)
- [Linear regression residuals and covariance](linear_regression_residuals_covariance_and_ddof.md)
