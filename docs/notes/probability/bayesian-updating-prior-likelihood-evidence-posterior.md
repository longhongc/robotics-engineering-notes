...
The 3D panel highlights both slices. The remaining panels show the prior,
likelihood at the observed value, unnormalized posterior numerator, normalized
posterior, and evidence as a function of possible observations.
